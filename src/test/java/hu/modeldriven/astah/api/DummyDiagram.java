...
public class DummyDiagram implements IDiagram {
    ...
    @Override
    public void setProperty(String s, String s1) throws InvalidEditingException {
    ...
    @Override
    public String exportImage(String s, String s1, double v) throws InvalidUsingException, InvalidExportImageException {
        return null;
    }
